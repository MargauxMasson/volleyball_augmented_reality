...
void myWidgetGL::paintGL()
{
    ...
    glClearColor (0.1f, 0.3f, 1.0f, 1.0f);                      PRINT_OPENGL_ERROR();
...
void myWidgetGL::setup_camera()
{
    ...
    cpe::mat4 world_matrix_zoom; world_matrix_zoom.set_translation({0.0f,0.0f,nav.dist_cam()-1.0f});//distance caméra
...
void myWidgetGL::mouvement_hands(int key)
{
    //std::cout<<"key"<<key<<std::endl;
    scene_3d.bouger_hands(key);

}

int myWidgetGL::get_compteur()
{
    return scene_3d.val_compteur;
}
