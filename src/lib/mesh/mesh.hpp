...
public:
    ...
    vec3 const& vertex(int index) const;
    vec3& vertex(int index);
    vec3 const& normal(int index) const;
    vec3& normal(int index);
    vec3 const& color(int index) const;
    ...
    void maillage(float xmin, float xmax, float zmin, float zmax, int Nu, int Nv);
    void maillage2(float xmin,float xmax,float zmin,float zmax,int Nu,int Nv);
    void filet(float xmin, float xmax, float ymin, float ymax);
    void cylindre (int N, float r, float h, float xcentre, float ycentre);
};
